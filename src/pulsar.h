...
const double TRANSIENT_AMPLIFICATION_TRESH = TRANSIENT_FILTER_AMPLIFICATION_TRESH;
const    int TRANSIENT_COUNT_TRESH = 150; // for dispersions 2-100 good value is 70
                                          // for dispersions 101-500 there is no good low value
